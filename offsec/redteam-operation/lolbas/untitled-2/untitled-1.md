...
## [./](https://blog.kedeshur.com/)kedeshur <a id="kedeshur"></a>
...
## 5MCT - Baselining Behavior Tradecraft <a id="5mct-baselining-behavior-tradecraft"></a>
...
#### Quick Story <a id="quick-story"></a>
...
#### Goals of the Talk <a id="goals-of-the-talk"></a>
...
#### Industry Today <a id="industry-today"></a>
...
#### Problem in Commoditized Attacks <a id="problem-in-commoditized-attacks"></a>
...
#### No Adversary Emulation Here <a id="no-adversary-emulation-here"></a>
...
#### Moving to Legitimate Behavior <a id="moving-to-legitimate-behavior"></a>
...
#### Fighting with Noise <a id="fighting-with-noise"></a>
...
### We’ve gotten lazy with hacking because it’s been so dang easy <a id="weve-gotten-lazy-with-hacking-because-its-been-so-dang-easy"></a>
...
#### Defense: Mapping Out Phases <a id="defense-mapping-out-phases"></a>
...
#### Defense: Where from Here? <a id="defense-where-from-here"></a>
...
#### Some Basics that Work <a id="some-basics-that-work"></a>
